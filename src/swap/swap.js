...
function Swap() {
  ...
  const getData = async () => {
    try {
      ...
      console.log("data", users, account, accountAd);
  ...
  const swapTokens = async () => {
    ...
    try {
      ...
      await tokenContract.methods.approve(contractAddress, web3.utils.toWei(enterAmount))
        ...
        .then(async (output) => {
          let dailyprofit = await contract.methods.swapTokens(web3.utils.toWei(enterAmount))
            .send({
              from: account
            })
            .then(async (output) => {
      ...
      <div className="Header">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-2 headerimg1">
              <h3 className="h3"><b>COINHUNTERS</b></h3>
            </div>
      ...
      <div className="headerbar">
        <div className="container">
          <div className="row mx-3 row1">
            {/* <div className="col-md headerbar2"> */}
            <div className="col-md-4" id="headerbar">
              <h3 id="h3"><b>How To Use Coinhunters</b></h3>
              <p id="span1" ><b id="span">Step 1:</b> Connect Wallet</p>
              <p id="span1"><b id="span">Step 2:</b> Swap V1 For V2</p>
              <p id="span1" ><b id="span">Step 3:</b> Add New Token To Your Wallet</p>
            </div>
            ...
            <div className="col-md-4 offset-md-4">
              <div className="card p-3 rounded-3">
                ...
                <div className="nputdv">
                  ...
                  <input min="0" className="form-control" id="floatingInput"
                    placeholder="Enter amount"
                    onChange={enterAmountCall}
                    value={enterAmount}
                  />

                  <button className="connect" onClick={maxClc}>max</button>

                </div>

                <button href="#" className="btn btn-warning my-3 py-3 text-white"
                  onClick={swapTokens}>Swap</button>
              </div>
            </div>
